...
# 5 "mcc_generated_files/memory.h" 2

# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\c99\\stdbool.h" 1 3
# 6 "mcc_generated_files/memory.h" 2
...
# 7 "mcc_generated_files/memory.h" 2
...
# 2 "mcc_generated_files/memory.c" 2
...
void DATAEE_WriteByte(uint16_t bAdd, uint8_t bData) {
    _Bool GIEBitValue = INTCONbits.GIE;
    EEADRH = ((bAdd >> 8) & 0x03);
    EEADR = (bAdd & 0xFF);
    EEDATA = bData;
    EECON1bits.EEPGD = 0;
