...
# 2 "mcc_generated_files/eusart1.c" 2
# 12 "mcc_generated_files/eusart1.c"
volatile uint8_t eusart1TxHead = 0;
volatile uint8_t eusart1TxTail = 0;
volatile uint8_t eusart1TxBuffer[24];
...
volatile uint8_t eusart1RxBuffer[24];



volatile eusart1_status_t eusart1RxStatusBuffer[24];
...
void EUSART1_Write(uint8_t txData) {
    while (0 == EUSART1_is_tx_ready()) {
    }



    if (0 == PIE1bits.TX1IE) {
# 153 "mcc_generated_files/eusart1.c"
        TXREG1 = txData;
    } else {
...
void EUSART1_RxDataHandler(void) {
    if (RCREG1 == 58 && DataRx1 == 0) {
        DataRx1 = 1;
        caracter_count = 0;
    } else if (DataRx1) {
        eusart1RxBuffer[eusart1RxHead] = RCREG1;
        if (eusart1RxBuffer[eusart1RxHead] == 59) {
