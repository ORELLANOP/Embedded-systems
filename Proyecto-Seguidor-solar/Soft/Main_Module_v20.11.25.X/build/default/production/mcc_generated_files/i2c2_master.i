...
# 5 "mcc_generated_files/i2c2_master.h" 2
...
# 6 "mcc_generated_files/i2c2_master.h" 2

# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\c99\\stdbool.h" 1 3
# 7 "mcc_generated_files/i2c2_master.h" 2
...
# 2 "mcc_generated_files/i2c2_master.c" 2
# 11 "mcc_generated_files/i2c2_master.c"
void i2c2_init(void) {
    SSP2STAT = 0x80;
...
uint8_t i2c2_Open(uint8_t slaveAddress, uint8_t address) {
    ...
    {SSP2CON2bits.SEN = 1; while(SSP2CON2bits.SEN);}
...
uint8_t i2c2_gets(uint8_t slaveAddress, uint8_t *ptrData, uint8_t length) {
    {SSP2CON2bits.RSEN = 1; while(SSP2CON2bits.RSEN);}
    SSP2BUF = slaveAddress | 0x01;
