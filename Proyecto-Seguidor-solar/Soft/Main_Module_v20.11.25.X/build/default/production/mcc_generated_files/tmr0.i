...
# 5 "mcc_generated_files/tmr0.h" 2
...
# 6 "mcc_generated_files/tmr0.h" 2

# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\c99\\stdbool.h" 1 3
# 7 "mcc_generated_files/tmr0.h" 2
...
# 2 "mcc_generated_files/tmr0.c" 2
# 13 "mcc_generated_files/tmr0.c"
...
uint16_t TMR0_WriteTimer(uint8_t timerVal) {
    uint16_t period;
    if (timerVal < 5)
        period = 65535 - ((5 * (64000000 / 1000)) / (4 * 32));
    else if (timerVal > 131)
        period = 65535 - ((131 * (64000000 / 1000)) / (4 * 32));
    else
        period = 65535 - ((timerVal * (64000000 / 1000)) / (4 * 32));
