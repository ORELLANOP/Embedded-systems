...
#define TMR0_Start1            25  // Período para aumento de cada 1% de duty en motor 1
#define TMR0_Stop1             25  // Período para decremento de cada 1% de duty en motor 1
    ...
    /* EPWM2_period es una función destinada a configurar el período
     * de la señal a la que se le modulará el ancho posteriormente.
     */

    void EPWM2_period(uint8_t freq);

    /* La función EPWM2_duty_const es utilizada exclusivamente por "EPWM2_period"
     * y por "EPWM2_engine_config". Básicamente genera el valor del intervalo que debe
    ...
    /* EPWM2_engine_config es una función diseñada para el manejo de motores por medio
    ...
    /* EPWM2_outputs_off, deshabilita físicamente al módulo ECCP2, 
     * generando una operación de shutdown
     */

    void EPWM2_outputs_off(void);

    /* EPWM2_outputs_on, habilita físicamente al módulo ECCP2 */
    ...
    /* EPWM2_SoftStart es una función de arranque suave, partiendo de duty 50%
